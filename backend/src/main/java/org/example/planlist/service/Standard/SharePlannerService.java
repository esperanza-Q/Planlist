...
import org.example.planlist.dto.StandardDTO.response.SharedPlannerResponseDTO;
...
//                notOneList
    ...
    @Transactional
    public StandardSession updateSelectTime(Long plannerId, SelectTimeRequestDTO dto) {
        // 기존 세션 찾기
