...
public class InviteUserResponseDTO {
    ...
    private List<org.example.planlist.dto.MeetingDTO.response.InviteUserResponseDTO.MyFriendDTO> myFriend;
    private List<org.example.planlist.dto.MeetingDTO.response.InviteUserResponseDTO.ParticipantDTO> participants;
